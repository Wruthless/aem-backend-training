 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.backendtrain.components.helloworld;
...
out.write("\n    ");
_global_model = renderContext.call("use", com.adobe.backendtraining.core.models.HelloWorldModel.class.getName(), obj());
{
...
out.write("\n</div>\n\n");
_global_devinfo = renderContext.call("use", com.adobe.backendtraining.core.services.DeveloperInfo.class.getName(), obj());
out.write("<div>");
{
