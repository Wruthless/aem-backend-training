package com.adobe.backendtraining.core.models.impl;


import com.adobe.backendtraining.core.StockDataWriterJob;
import com.adobe.backendtraining.core.models.Stockplex;
...
public class StockplexImpl implements Stockplex {
    ...
    public String getShowStockInfo() {
        return currentStyle.get("showStockInfo", false).toString();
    }
    ...
    //Used by the JSON exporter to populate the `:type` key in the JSON object
    @Override
    public String getExportedType() {
        return request.getResource().getResourceType();
    }
/**
 * Uncomment the following code to enable the data layer
 *
